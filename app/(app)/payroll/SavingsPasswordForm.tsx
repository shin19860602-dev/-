...
import { setSavingsPassword } from "./actions";

export default function SavingsPasswordForm({ storeId, storeName, isSet }: { storeId: string; storeName: string; isSet: boolean }) {
        ...
        <form
          ...
          action={(formData) => {
            ...
            startTransition(async () => {
              const result = await setSavingsPassword(formData);
              if (result.ok) {
                setOpen(false);
                router.refresh();
              } else {
